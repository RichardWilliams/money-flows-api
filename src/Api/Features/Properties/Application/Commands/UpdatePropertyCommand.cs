...
internal sealed class UpdatePropertyCommandHandler : IRequestHandler<UpdatePropertyCommand, PropertyDto>
{
    private readonly PropertyManagementDbContext _context;

    public UpdatePropertyCommandHandler(PropertyManagementDbContext context)
    {
        _context = context;
    }
